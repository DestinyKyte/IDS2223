...
public class UnionProgramPendingAnswersController {
    private final UnionProgramPendingAnswersService pendingAnswersService;

    @Autowired
    public UnionProgramPendingAnswersController(UnionProgramPendingAnswersService pendingAnswersService) {
